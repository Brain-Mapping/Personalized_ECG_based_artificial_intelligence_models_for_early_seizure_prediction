			...
			interictal_start_time = actual_onset_in_seconds-(30*60);
			interictal_end_time =actual_onset_in_seconds-(15*60);
			...
			for i = 1:num_chunks
				...
				ylabel('Amplitude');
				i
				d = ECG(matrix_preictal(i,1:end-1), fs, 250); 
				d.init;
			...
			for i = 1:num_chunks
				...
				xlabel('Time (s)');
				ylabel('Amplitude');
				d = ECG(matrix_interictal(i,1:end-1), fs, 250); 
				d.init;
